...
dataFolder <- "~/Bioinformatics/dataRepo"
...
# REDCap import
source(file.path(here("RScripts", "redcap_api_import.R")))
...
```{r import STOP, warning=FALSE, error=FALSE, message=FALSE, results=FALSE}
